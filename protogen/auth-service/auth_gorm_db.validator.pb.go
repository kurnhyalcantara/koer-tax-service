...
func (this *Authentication) Validate() error {
	if this.LastChangePassword != nil {
		if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(this.LastChangePassword); err != nil {
			return github_com_mwitkow_go_proto_validators.FieldError("LastChangePassword", err)
		}
	}
	return nil
}
...
func (this *LoginLogs) Validate() error {
